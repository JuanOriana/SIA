...
def main():
    ...
    neural_network = NeuralNetwork([layer1,layer2,layer3,layer4],sigmoid_tanh_activation,sigmoid_tanh_activation_derivative,0.1)
    ...
    print("training...")
    neural_network.train(inputs, inputs, 10)
    end_time = time.time()
    ...
    outputs = neural_network.activate(inputs[0])
    print (outputs[-1])
